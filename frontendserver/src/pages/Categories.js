...
export let DUMMY_DATA = [
  {
    ...
    composition:
      " Contains amoxicillin trihydrate and flucloxacillin sodium monohydrate equivalent to Amoxicillin 500 mg.",
    ...
    Adverse_Effects:
      "Floxamo® is well tolerated but in rare cases diarrhea, nausea or cholestatic jaundice which is reversible, may occur.",
    Dosage_Administration:
      "Dose for adults: one tablet every 8 hours (every 6 hours in severe infections).  Dose for children (8-16years): 1/2 tablet every 8 hours. ",
  },
  {
    id: 2,
    image: nex,
  ...
  },
  {
    ...
    composition:
      " Contains amoxicillin trihydrate and flucloxacillin sodium monohydrate equivalent to Amoxicillin 500 mg.",
    Adverse_Effects:
      "It is well tolerated but in rare cases diarrhea, nausea or cholestatic jaundice which is reversible, may occur.",
    usage1: "Skin and soft tissue infections.",
    usage2: "Bone and joint infections.",
    usage3: "Upper and lower respiratory tract infections.",
    Dosage_Administration:
